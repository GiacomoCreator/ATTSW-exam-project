...
public class SupermarketWebControllerHtmlUnitTest {
	...
	public void test_homePage_withSupermarkets() throws Exception {
		when(supermarketService.getAllSupermarkets())
			.thenReturn(
				asList(
					new Supermarket(BigInteger.valueOf(1), "supermarket1", "address1"),
					new Supermarket(BigInteger.valueOf(2), "supermarket2", "address2")));
	...
	public void test_editPageTitle() throws Exception {
		...
		when(supermarketService.getSupermarketById(BigInteger.valueOf(1))).thenReturn(supermarket);
	...
	public void test_editExistingSupermarket() throws Exception {
		when(supermarketService.getSupermarketById(BigInteger.valueOf(1)))
			.thenReturn(new Supermarket(BigInteger.valueOf(1), "oldSupermarket", "oldAddress"));
		...
		verify(supermarketService)
			.updateSupermarketById(BigInteger.valueOf(1), new Supermarket(BigInteger.valueOf(1), "newSupermarket", "newAddress"));
	}
	...
	public void test_searchPage_withSupermarkets() throws Exception {
		...
		Supermarket testSupermarket1 = new Supermarket(BigInteger.valueOf(1), "existingSupermarket", "address1");
		Supermarket testSupermarket2 = new Supermarket(BigInteger.valueOf(2), "existingSupermarket", "address2");
